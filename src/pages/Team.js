    ...
    <>
      <div className={"team__container"}>
        ...
        <div className="team__flex">
          <Card img_url={require("../components/team/assets/team/IMG-20221119-WA0004.jpg")} name={"Alex Chika"}
                position={"Front-End Dev"} />
          <Card img_url={require("../components/team/assets/team/IMG-20221119-WA0005.jpg")} name={"Busayo Olushola"}
                position={"DevOps"} />
          <Card img_url={require("../components/team/assets/team/IMG-20221119-WA0006.jpg")} name={"Andrew Glado"}
                position={"Backend"} />
