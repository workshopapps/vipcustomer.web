  ...
  return (
    <div className="documents-div">
      ...
      <p>
        ...
        it/they should pop up for use.
      </p>
      <p>
        To have a succesfull search-many response, the following parameters must
        be inputed: name of person(s), gender, occupation(s), age(s), email
        address(es).
      </p>
      <iframe
